...
<head>
    ...
    <title>ATG TASK!3| Register</title>
    <style>
                        ...
                        @csrf
                            <div class="login-div">
                                <div class="form-group">
                                    <label class="card-input-heading">Name</label>
                                    <div class="card-input-box">
                                        <input type="text" pattern="[A-Za-z ]{1,32}" class="card-input" name="name" placeholder="Enter your Name" value="{{ old('name') }}" required/>
                                    </div>
                                    <span class="error-text text-danger">@error('name'){{ $message }} @enderror</span>
                                </div>
                                <div class="form-group">
                                    <label class="card-input-heading">Email</label>
                                    <div class="card-input-box">
                                        <input type="email" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$" required class="card-input" name="email" placeholder="Enter you Email Address" value="{{ old('email') }}" required/>
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="card-input-box">
                                        <input type="password" class="card-input" name="password" placeholder="Enter password" required/>
                                    </div>
                                ...
                                <a href="{{ route('auth.login') }}" class="new-account">Already have an account? <span class="new-account-signup">Signin</span></a>
                            </div>
                        </form>
                    </div>
                </div>
